...
const sessionForgeTheme: SystemConfig = {
  theme: {
    tokens: {
      fonts: {
    ...
    textStyles: {
      heading: {
        ...
        value: {
          ...
          color: '{colors.cthulhu-green-500}',
          lineHeight: 'short',
        },
      },
      subheading: {
...
const sessionForgeSystem = createSystem(defaultConfig, sessionForgeTheme);

export default sessionForgeSystem;
